 ...
 */
public abstract class GroupExpandableAdapter extends RecyclerView.Adapter implements AbstractExpandableAdapterItem.ParentListItemExpandCollapseListener {
    ...
    protected GroupExpandableAdapter(List data) {
        if (data == null) return;
        this.mDataList = data;
    ...
    public void manageChildItem(ExpandableListItem a , int position)
    {
        a.getChildItemList().remove(position);
//        notifyItemRemoved();
    }
